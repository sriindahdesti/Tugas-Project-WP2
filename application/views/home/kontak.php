<body class="sub_page">
        ...
        <nav class="navbar navbar-expand-lg custom_nav-container fw-bold">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto ">
              <li class="nav-item ">
                <a class="nav-link" href="<?= base_url('home/index') ?>">HOME </span></a>
              </li>
              <li class="nav-item ">
  ...
  <section class="layyout-padding mt-5 mb-5">
    ...
    <?= form_open_multipart('home/kirimPesan'); ?>
    <div class="container">
        ...
        <div class="row d-flex justify-content-between ">
          ...
          <div class="col-12 col-lg-5 col-md-5 col-sm-12 pb-2 ">
            <div class="mb-2">
              ...
              <input type="text" required class="form-control" id="nama" name="nama" placeholder="Nama Pengirim" value="">
            </div>
            <div class="mb-2">
              <label class="form-label">Email</label>
              <input type="email" required class="form-control" id="email" name="email" placeholder="pengguna@email.com" value="">
            </div>
            <div class="mb-4">
              <label class="form-label">Pesan</label>
              <textarea type="text" required class="form-control" id="pesan" name="pesan" value="" placeholder="Pesan anda"></textarea>
            </div>
            <div class="mb-2">
              <button type="submit" class="btn btn-zen">Kirim</button>
            </div>
          </div>

          <div class="col-12 col-lg-5 col-md-5 col-sm-12 pb-2  ">
            <h4 class="mb-4">Atau Hubungi</h4>
